...
struct EnhancedPlayNowView: View {
    ...
    // MARK: - Health Store & Location Manager
    ...
    // MARK: - Round Summary View
        ...
        private func startRound() {
            ...
            print("Starting round with: Course: \(course.Name), Holes: \(holeCount), Section: \(nineHoleSection)")
            isTracking = true
            startTime = Date()
        ...
        private func shareRound() {
            var shareText = "I just finished a round at \(selectedCourse?.Name ?? "")!\n"
